...
function start() {
	...
	// VERIFICAR OUTRAS JANELAS ABERTAS
	var x = document.getElementById("creditos");
	...
	// TECLAS
	var TECLA = {//varlor keycode de cada tecla
	W: 87, //up
	S: 83, //down
	D: 68 // shot
	}
	...
	// MOVE PERSONAGEM, VEICULOS E COLISAO
	movefundo();
	movejogador();
	moveamigo();
	moveinimigo1();
	...
	function gameOver() {
		...
		$("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia' ><button onClick=reiniciaJogo()>Jogar Novamente</button><button onClick=restart()>Sair</button></div>");
	}
...
function comojogar() {
 	...
 	var y = document.getElementById("creditos");
